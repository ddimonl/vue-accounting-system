<template>
  ...
  <div class="card-content">
    ...
    <div class="input-field">
      ...
      <small v-else-if="$v.password.$dirty && !$v.password.minLength" class="helper-text invalid">Длина праоля должна составлять минимум {{$v.password.$params.minLength.min}}. Сейчас {{password.length}}</small>
